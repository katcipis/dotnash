...
fn callburguesa(host) {
    ...
    gst-launch-1.0 -v pulsesrc ! opusenc ! rtpopuspay ! rtpjitterbuffer ! udpsink $host "port=5001" "async=false" udpsrc "port=5001" "caps=application/x-rtp,media=audio,payload=96,clock-rate=48000,encoding-name=OPUS" ! rtpjitterbuffer ! rtpopusdepay ! pulsesink
}
